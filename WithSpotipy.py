...
def get_spotify_client() -> Spotify:
    ...
    spotify_client_id = #Your Dev ID Goes Here
    spotify_client_secret = #Your Dev Secret Goes Here
...
if __name__ == "__main__":
    ...
    if check_date(date):
        ...
        playlist_name = "Top Songs of: " + date
        ...
        if playlist_id != 0:  # Playlist didn't exist
            ...
            print("That playlist already exists")
